...
<template>
  <Card class="w-full">
    <CardHeader>
      ...
      <CardDescription>
        Los códigos de recuperación te permiten acceder si pierdes tu dispositivo 2FA. Guárdalos en
      ...
      >
        ...
        <div v-else class="mt-3 space-y-3">
          ...
          <p class="text-xs text-muted-foreground select-none">
            ...
            eliminará después de utilizarlo. Si necesitas más, haz clic en
