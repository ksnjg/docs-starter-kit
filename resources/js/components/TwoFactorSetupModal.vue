...
const modalConfig = computed<{
  ...
  if (showVerificationStep.value) {
    return {
      ...
      description: 'Ingresa el código de 6 dígitos desde tu aplicación autenticadora',
  ...
  return {
    ...
    description:
      'Para terminar de activar la autenticación en dos pasos, escanea el código QR o ingresa la clave de configuración en tu aplicación autenticadora',
    buttonText: 'Continuar',
  };
});
